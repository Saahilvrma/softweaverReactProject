                                    ...
                                    <div className=''>
                                        ...
                                        <div className="min-[480px]:grid grid-cols-6 gap-10 mt-4">
                                            <div className='col-span-3'>
                                                <input type="text" {...register("CrutorRequired", { required: true })} className="hauser ml-12 bg-white leading-5 border-2  hover:bg-white border-blue-200  text-gray-600 py-2.5 px-4  rounded-lg" placeholder='Curator' />
                                            ...
                                            <div className='col-span-3'>
                                                <input type="text"  {...register("HauserRequired", { required: true })} className="hauser ml-12 bg-white leading-5 border-2  hover:bg-white border-blue-200  text-gray-600 py-2.5 px-4  rounded-lg" placeholder='Hauser & Wirth' />

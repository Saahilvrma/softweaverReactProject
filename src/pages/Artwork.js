        ...
        <>
            ...
            <div className="pt-10 sm:ml-48 top-20 bg-gray-200 h-full" >
                ...
                <div className="p-4 border-1 border-blue-400 border-dashed mx-6 rounded-lg dark:border-blue-700 h-full top-20 bg-white">
                    <div className="grid grid-cols-6 gap-6 " onClick={handleOnClick}>                         
                            <div className="col-span-1 ...">
                            ...
                            <div className="col-span-1 ... flex">
                                ...
                                <div className="data">
                                    ...
                                    <select className="text-md text-black bg-transparent border-none mr-1" >
                                            ...
                                            <div className="grid grid-cols-4 ">
                                                ...
                                                <div className="col-span-2 ...">
                                                    <div className="mt-5 mb-5 ml-8">
                                                        ...
                                                        <span className='flex'><p className='text-lg font-extrabold ml-2'>Bat on Hearts</p><span className='top-4 right-4 absolute'> <FiEdit2 /> </span></span>
                                                        <p className='text-sm ml-2'>No Description</p>
                                                        
                                                        <div className="mt-6 mb-4">
                                                            <a href="/" className="underline text-sm ml-2 mt-8">Acrylic and Oil Canvas</a> | <a href="/" className="underline mt-8 text-sm">Available</a> | <a href="/" className="underline mt-8 text-sm ">$8,500.00</a>
                                                        </div>
                                                        <div className="ml-2 flex">
                                                            ...
                                                            <div className="data">
                                                                <p className="mt-2 text-sm  ml-3">Painitng</p>
                                                                <p className="mt-2 text-sm  ml-3">69w x 90h</p>
                                                                <p className="mt-2 text-sm  ml-3">Nature,exoresion</p>
